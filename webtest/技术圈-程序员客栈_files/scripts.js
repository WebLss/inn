...
(function() {
  ...
  EkkoLightbox.prototype = {
    ...
    close: function() {
      return this.modal.hubModal('hide');
    },
        ...
        initEditorPreview: function() {
            ...
            $("#reply_content").focus(function(event) {
                ...
                if (!$("#reply_content").val()) {
                    var replyNoticeScrollTop = $('#reply_notice').offset().top;
                    console.log(replyNoticeScrollTop);
                    $("html, body").animate({ scrollTop: replyNoticeScrollTop-90}, 500);
                }
            });
                        ...
                        if (data.status === 200) {
                            ...
                            tpl = '<li class="list-group-item media" style="margin-top: 0px;">\
                                <div class="avatar pull-left">\
                                    <a href="/wo/' + data.reply.user_id + '"><img class="media-object img-thumbnail avatar" alt="' + data.reply.user.name + '" src="' + data.reply.user.image_url + '" style="width:48px;height:48px;"></a>\
                                </div>\
                                <div class="infos">\
                                    <div class="media-heading">\
                                        <a href="/wo/' + data.reply.user_id + '" title="' + data.reply.user.name + '" class="remove-padding-left author">' + data.reply.user.name + '</a>\
